            ...
            <div className="my-12">
                <form className="border border-slate-500 rounded-md max-w-lg mx-auto p-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <input className="bg-transparent py-2 border-b outline-none" type="text" name="f_Name" placeholder="First Name" id="" />
                        <input className="bg-transparent py-2 border-b outline-none" type="text" name="l_Name" placeholder="Last Name" id="" />
